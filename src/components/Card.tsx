          ...
          <div className="fixed inset-0  grid place-items-center z-[100]">
            ...
            >
              ...
              <div>
                ...
                <div>
                    {/* motion div for contact no. */}
                    <motion.h3
                      layoutId={`title-${active.contact}-${id}`}
                      className="font-semibold text-neutral-700 dark:text-neutral-200 mx-4"
                    >
        ...
        {society.map((card, index) => (
          ...
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-gray-200 hover:bg-blue-500 hover:text-white text-black mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
