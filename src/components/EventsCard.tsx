...
export function EventsCard() {
  ...
  return (
    <>
      ...
      <ul className="max-w-2xl lg:max-w-3xl mx-auto w-full flex flex-col md:flex-row items-stretch gap-4">
        {events.map((card) => (
          <motion.div
          ...
          >
            <div className="flex gap-4 flex-col items-center w-full">
              ...
              <button className="bg-gray-300 border rounded-full px-2 py-1">
                Select
              </button>
            </div>
          </motion.div>
